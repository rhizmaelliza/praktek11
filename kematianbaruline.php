...
include ('koneksi.php'); 
	...
	while ($row = mysqli_fetch_array($covid) ) {
		...
		$jumlah_kematianbaru[] = $row['kematianbaru']; 
	}
?> 
...
<html> 
<head>
	<title>New Deaths - Line Chart</title>
...
<body><center>
	...
	<script type="text/javascript">
		var myChart = new Chart("myChart", { 
			...
			data: { 
				datasets: [{
					label: 'New Deaths - Line Chart', 
					data: <?php echo json_encode($jumlah_kematianbaru);?>,
					...
					label: 'Persentase Total Sembuh Baru Covid'
				}],
