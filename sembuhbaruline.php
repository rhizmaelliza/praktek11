...
include ('koneksi.php'); 
	...
	while ($row = mysqli_fetch_array($covid) ) {
		...
		$query = mysqli_query($koneksi,"select sum(sembuhbaru) as sembuhbaru from tb_covid where id='". $row['id']."'"); 
		$row = $query->fetch_array(); 
		$jumlah_sembuhbaru[] = $row['sembuhbaru']; 
	}
?> 
...
<html> 
<head>
	<title>New Recovered - Line Chart</title>
...
<body><center>
	...
	<script type="text/javascript">
		var myChart = new Chart("myChart", { 
			...
			data: { 
				datasets: [{
					label: 'New Recovered - Line Chart', 
					data: <?php echo json_encode($jumlah_sembuhbaru);?>,
